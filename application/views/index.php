    ...
    <div class="container">
      <div class="row slider-text align-items-center justify-content-center">
        <div class="col-lg-12 text-center col-sm-12">
          <h1 class="mb-4" data-aos="fade-up" data-aos-delay="100">#1 En linea de Transporte público</h1>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 order-1">
          <figure class="img-dotted-bg">
            ...
            <img src="038.jpg" alt="Image" class="img-fluid img-absolute" data-aos="fade-left">
  ...
  <div sclass="section bg-light block-11">
    <div class="container">
